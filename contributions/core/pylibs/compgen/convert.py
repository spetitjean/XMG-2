...
from xmg.compgen.brick_parser import semicolon,colon,pipe,arrow,endsection,_id,sqstring,coma,equal,openpred,closepred,star,plus,question,T,NT,EXT,action,sepMacro
