...
class VerbSem
      ...
      { <syn>{ node xVerbSem[top=[idx=I,label = L]]}*=[vbI = I, topL = L]}
...
declare ?Rel ?E ?L0 ?fTse ?fMode ?fSecant
	...
	<sem>{
		L0:Rel(E); L0:event(E,fTse,fSecant,fMode)
	      }*=[label0 = L0, rel =Rel,arg0=E,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant]
	  }
...
declare ?Rel ?E ?L0
	...
	<sem>{
		L0:Rel(E)
	      }*=[label0 = L0, rel =Rel,arg0=E,vbLabel=L0]
	  }
...
declare ?Rel ?E ?L0 ?H ?LV
	...
	<sem>{
		L0:Rel(E,H); qeq(H,LV)
	      }*=[sobjectL=LV,label0 = L0, rel =Rel,arg0=E,vbLabel=L0]
	  }
...
declare ?Rel ?E ?L0 ?H ?LV  ?fTse ?fMode ?fSecant
	...
	<sem>{
		L0:Rel(E,H); qeq(H,LV); L0:event(E,fTse,fSecant,fMode)
	      }*=[sobjectL=LV,label0 = L0, rel =Rel,arg0=E,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant]
	  }
...
declare ?Rel ?E ?L0 ?N ?G
	...
	<sem>{
		L0:Rel(E); L0:indiv(E,G,N)
	      }*=[label0 = L0, rel =Rel,arg0=E,vbLabel=L0,num=N,gen=G]
	  }
...
declare ?L0 ?Rel ?E ?X  ?fTse ?fMode ?fSecant
	...
	<sem>{
		L0:Rel(E,X); L0:event(E,fTse,fSecant,fMode)
	      ...
	      *=[label0 = L0, rel =Rel,arg0=E,arg1=X,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant] 
	  }
...
declare  ?L0 ?E ?X ?Y ?fTse ?fMode ?fSecant
	...
	<sem>{
	      ...
	      *=[label0=L0,arg0=E,arg1=X,arg2=Y,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant] 
	  }
...
declare  ?L0 ?Rel ?E ?X ?Y ?fTse ?fMode ?fSecant ?AH
	...
	<sem>{
	      ...
	      *=[label0=L0, rel=Rel,arg0=E,arg1=X,arg2=AH,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant] 
	  }
...
declare  ?L0 ?Rel ?E ?X ?Y ?fTse ?fMode ?fSecant
	...
	<sem>{
	      ...
	      *=[label0=L0, rel=Rel,arg0=E,arg1=X,arg2=Y,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant] 
	  }
class binaryRelBase
declare  ?L0 ?Rel ?E ?X ?Y
	...
	<sem>{
	      ...
	      *=[label0=L0, rel=Rel,arg0=E,arg1=X,arg2=Y,vbLabel=L0] 
	  }
...
declare  ?L0 ?Rel ?E ?X ?Y ?Z  ?fTse ?fMode ?fSecant
	...
	<sem>{
	      ...
	      *=[label0 = L0, rel =Rel,arg0=E,arg1=X,arg2=Y,arg3=Z,vbLabel=L0,tense=fTse,mode=fMode,aspect=fSecant]
}
...
class whPronounQuantifierSem
      export xNounSem
      declare ?x ?I ?RH ?SH ?NL ?xNounSem ?Noun ?L ?Quant ?N ?G 
      { <syn>{ node xNounSem[top=[idx = I,label = L]]};
      	<sem>{L:Quant(I,RH,SH); NL:Noun(I); qeq(RH,NL)}*=[arg0=I,label=L,quant=Quant,noun=Noun,rlabel=NL]}
...
class pronounQuantifierSem
      ...
      { <syn>{  node xN(color=white)[cat=@{n,cl},bot=[idx=I,num=N,pers=P,gen=G]]};
      	<sem>{L0:pronoun_q(I,HR,HS); L1:pron(I); L1:indiv(I,N,G,P);qeq(HR,L1)}*=[arg0=I,num=N,pers=P,gen=G]}

% chante-t'il?
class questionCliticSem
declare ?E ?L ?xN ?I ?L0 ?I ?HR ?HS ?L1 ?N ?P ?G
      { 
        <sem>{L:question(E); L0:pronoun_q(I,HR,HS); L1:pron(I); L1:indiv(I,N,G,P);qeq(HR,L1)}*=[arg0=I,labelV=L,num=N,pers=P,gen=G,argV=E]
	  }
